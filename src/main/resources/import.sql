...
insert into student values (5, '2009-03-02', 'Anna', 'user4', 'Piaty', 'STUDENT', 'ann' );
insert into student values (6, '2009-03-02', 'Katarzyna', 'user5', 'Szósty', 'STUDENT', 'kate' );
...
insert into teacher values (1, 'Piotr', 'piotr1', 'Pierwszy', 'TEACHER', 'pete');
...
insert into school_subject values (1, 'Math');
insert into school_subject values (2, 'English');
